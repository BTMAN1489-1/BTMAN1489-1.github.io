...
function t_lazyLoad__appendImgStatToArr(img, startTime) {
    if (void 0 !== navigator.sendBeacon) {
        ...
        if (imgSrc) {
            ...
            0 === imgSrc.indexOf("https://thumb.tildacdn") && (imgLoadingTime.th = "y"),
...
!function(root, factory) {
    ...
    var _defaultSettings, _supportsClassList, _isInitialized = !1, _popularResolutions, _popularResolutionsOther, _supportsObserver = !1;
    function _init() {
    ...
    function t_lazyload__getResizeUrl(tagName, comm, str, width, height, x, y) {
        if ("undefined" == str || null == str)
            return str;
        if (str.indexOf(".svg") > 0 || str.indexOf(".gif") > 0 || str.indexOf(".ico") > 0 || str.indexOf("-/empty/") > 0 || str.indexOf("-/resizeb/") > 0)
            return str;
        if (str.indexOf("/-/") > -1)
            return str;
        if (0 == width && 0 == height)
...
window.t_lazyload_updateResize_elem = function(elem) {
    ...
    if (null != elem) {
        ...
        if ("IMG" == tagName)
            ...
            var prefix = "-/cover/";
        if (!(null == str || -1 === str.indexOf(prefix) || str.indexOf(".svg") > 0 || str.indexOf(".gif") > 0 || str.indexOf(".ico") > 0 || str.indexOf("-/empty/") > 0 && str.indexOf("-/resizeb/") > 0)) {
